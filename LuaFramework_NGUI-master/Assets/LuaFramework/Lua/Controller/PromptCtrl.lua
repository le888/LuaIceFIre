...
function PromptCtrl.OnCreate(obj)
    ...
    logWarn("Init TestBtn--->>");
    logWarn("Init TestBtn--->>2222222222222222"..PromptPanel.TestBtn.name);
    prompt:AddClick(PromptPanel.TestBtn, this.OnClickTest);
end
...
function PromptCtrl.OnClickTest(go)

    logWarn("TestBtn Click");
    logWarn(tostring(CtrlManager.GetCtrl(CtrlNames.PopMessage) == nil))
    CtrlManager.GetCtrl(CtrlNames.PopMessage).Awake();
end
